...
synth_design -top TopLevelDesign_wrapper -part xc7z020clg400-1
...
generate_parallel_reports -reports { "report_utilization -file TopLevelDesign_wrapper_utilization_synth.rpt -pb TopLevelDesign_wrapper_utilization_synth.pb"  } 
